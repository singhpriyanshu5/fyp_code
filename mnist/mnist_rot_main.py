...
DATA_DIR = '/Users/priyanshusingh/Documents/tf_stuff/data/mnist'
BATCH_SIZE = 50
...
## Don't need a separate input pipeline for mnist can simply use the helper mnist
...
def inputs(eval_data, rotation_only):
