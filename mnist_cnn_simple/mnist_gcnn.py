...
#comment out the following block of code for non rotated test images
...
images_rotated_test = tf.reshape(images_rotated_test, [-1, test_data.shape[1]])
test_data = images_rotated_test
...
class Graph_ConvNet_LeNet5(object):
    ...
    def __init__(self, net_parameters):
        ...
        self.WCL2 = self.init_weights([CL2_K*CL1_F,CL2_F],CL1_K*CL1_F,CL2_F)
